...
The convexity measures are defined in *Albeke, S.E. et al. [Measuring boundary convexity at multiple spatial scales using a linear 'moving window' analysis: an application to coastal river otter habitat selection](https://www.d.umn.edu/biology/documents/Nibbelink2_000.pdf) Landscape Ecology 25 (2010): 1575-1587 are briefly described as follows:


sfnetworks more recent - see another chapter
